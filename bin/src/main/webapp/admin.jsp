			...
			<h3>ADMIN CONSOLE</h3></B>
			 ...
			 <div style="text-align: center;">
			    <button type="submit" class="btn btn-light" onclick="openAddVehicle()">ADD VEHICLE</button>
			           ...
			           <div style="text-align: center;">
			    <button type="submit" class="btn btn-light" onclick="openRemoveVehicle()">REMOVE VEHICLE</button>
			          </div><br>
			           <div style="text-align: center;">
			    <button type="submit" class="btn btn-light" onclick="openUpdateVehicle()">UPDATE VEHICLE STATUS</button>
			          </div><br>
			           <div style="text-align: center;">
			    <button type="submit" class="btn btn-light" onclick="openAddDriver()">ADD DRIVER</button>
			          </div><br>
			           <div style="text-align: center;">
			    <button type="submit" class="btn btn-light" onclick="openRemoveDriver()">REMOVE DRIVER</button>
			          </div><br>
			          <br>
			          <br>
			          <br>
	  ...
	  <div style="text-align: center ;color:GREEN;"><B>
		<h3>REMOVE VEHICLE</h3></B>
		   ...
		   <div>
		    ...
		    <input type="text" class="form-control" id="Rvehicle_id">
		          </div>
	  ...
	  <div style="text-align: center ;color:GREEN;"><B>
		<h3>REMOVE DRIVER</h3></B>
		   ...
		   <div>
		    ...
		    <input type="text" class="form-control" id="Rdriver_id">
		          </div>
	  ...
	  <div style="text-align: center ;color:GREEN;"><B>
		<h3>UPDATE VEHICLE STATUS</h3></B>
		   ...
		   <div>
		    ...
		    <input type="text" class="form-control" id="VupdateStatus">
		          </div>
		          <div style="text-align: center;">
